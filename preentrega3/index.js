...
//     Dentro de esta función, utiliza un reduce para crear elementos HTML para cada producto, estilízalos mínimamente 
//     y agrega un botón "Agregar al Carrito" que al hacer clic lo agregue al almacenamiento local.
...
//    c. Escribe una función llamada `generarInfoPokemon` que reciba el array de datos de Pokémon como argumento. Dentro de esta función,
//     utiliza un reduce para crear elementos HTML que muestren los detalles de cada Pokémon. 
//     Dentro de cada una de las tarjetas, tiene que haber un botón con un ícono de estrella. Estilízalos mínimamente. 
...
//    c. Escribe una función llamada `generarPublicaciones` que reciba el array de publicaciones como argumento. 
//     Dentro de esta función, utiliza un bucle para crear elementos HTML que muestren las publicaciones, estilízalos mínimamente.
